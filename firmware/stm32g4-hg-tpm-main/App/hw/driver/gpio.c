...
const gpio_tbl_t gpio_tbl[HW_GPIO_MAX_CH] =
{
  ...
  {P_OUT1_GPIO_Port,    P_OUT1_Pin,    _DEF_OUTPUT,       GPIO_PIN_SET, GPIO_PIN_RESET, _DEF_LOW,  "P_OUT1"   },
  {P_OUT2_GPIO_Port,    P_OUT2_Pin,    _DEF_OUTPUT,       GPIO_PIN_SET, GPIO_PIN_RESET, _DEF_LOW,  "P_OUT2"   },
  {P_OUT3_GPIO_Port,    P_OUT3_Pin,    _DEF_OUTPUT,       GPIO_PIN_SET, GPIO_PIN_RESET, _DEF_LOW,  "P_OUT3"   },
  {P_OUT4_GPIO_Port,    P_OUT4_Pin,    _DEF_OUTPUT,       GPIO_PIN_SET, GPIO_PIN_RESET, _DEF_LOW,  "P_OUT4"   },
  {P_OUT5_GPIO_Port,    P_OUT5_Pin,    _DEF_OUTPUT,       GPIO_PIN_SET, GPIO_PIN_RESET, _DEF_LOW,  "P_OUT5"   },
  {P_OUT6_GPIO_Port,    P_OUT6_Pin,    _DEF_OUTPUT,       GPIO_PIN_SET, GPIO_PIN_RESET, _DEF_LOW,  "P_OUT6"   },
  ...
  {P_IN5_GPIO_Port,     P_IN5_Pin,     _DEF_INPUT,        GPIO_PIN_SET, GPIO_PIN_RESET, _DEF_HIGH, "P_IN5"    },
  {P_IN6_GPIO_Port,     P_IN6_Pin,     _DEF_INPUT,        GPIO_PIN_SET, GPIO_PIN_RESET, _DEF_HIGH, "P_IN6"    },
  ...
  {U3_WAKEUP_GPIO_Port, U3_WAKEUP_Pin, _DEF_INPUT_PULLUP, GPIO_PIN_SET, GPIO_PIN_RESET, _DEF_HIGH, "U3_WAKEUP"},
};
